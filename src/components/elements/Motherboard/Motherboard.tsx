                    ...
                    <div className='overflow-hidden pb-3'>
                        <div className='pt-1 font-mono text-sm'>
                            <div className='space-x-2'>
                                ...
                                {/*Items*/}
                                {motherboardItems.map(( motherboard: MotherboardItems ) => (
                                    <Dialog
                                        transition={{
                                            type: 'spring',
                                            stiffness: 200,
                                                        ...
                                                        <div className='bg-white gap-4'>
                                                            <div className='w-full h-full flex p-2 gap-1 items-center'>
                                                                <DialogImage
                                                                    ...
                                                                    style={{borderRadius: '4px'}}
                                                                />
                                                                <text className='w-full'>{motherboard.name}</text>
                                                                <text className='w-1/6'>{motherboard.Socket}</text>
                                                                <text className='w-1/6'>{motherboard.RAM}</text>
                                                                <text className='w-1/6'>{motherboard.price}₽</text>
                                                            </div>
                                                        </div>
                                                    </>
                                                </div>
