                            ...
                            <div className='space-x-2'>
                                <div className='relative w-full flex gap-4 h-12 items-center'>
                                    <Autocomplete
                                        ...
                                        options={gpuItems.map(( gpu: GPUItems ) => {return gpu.name})}
                                    />
                                    ...
                                    >
                                        <DialogTrigger>
                                            <div
                                                className="border border-zinc-950/10 bg-transparent rounded-lg p-2 text-zinc-900 placeholder-zinc-500 flex text-center items-center gap-2">
